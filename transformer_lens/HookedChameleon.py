...
class HookedChameleon(HookedRootModule):
    """Hooked Transformer.
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList(
            [ChameleonBlock(self.cfg, block_index) for block_index in range(self.cfg.n_layers)]
        )
        ...
        with utils.LocallyOverridenDefaults(
            ...
            for i, block in blocks_and_idxs[start_at_layer:stop_at_layer]:  # type: ignore
                ...
                if return_attentions:
                    residual, output_attention = block(
                        residual,
            ...
            if return_type is None:
                ...
                with open("/aifs4su/yaodong/projects/hantao/personal/TransformerLens/img_token_list.txt", "r") as f:
                    data = f.read()
                    img_token_list = eval(data)
                logits[:, :, img_token_list] = torch.finfo(logits.dtype).min
                ...
                if return_type == "logits":
                    return logits
                elif return_type == "hidden_states":
                    return residual
                elif return_type == "attentions":
                    return output_attentions
                else:
                    assert (
                        tokens is not None
    ...
    def from_pretrained(
        ...
        **from_pretrained_kwargs,
        ...
        #     print(name)
        #     print(param.shape) if param is not None else print("None")
